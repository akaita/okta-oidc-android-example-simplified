...
This repository contains a simplified example showcasing how to use [Okta OIDC SDK](https://github.com/okta/okta-oidc-android) implementing:
...
For a more complete example, head over to the [okta-oidc-android-example repository](https://github.com/akaita/okta-oidc-android-example)
...
<img src="./images/unauthenticated.png" width="600" /><img src="./images/oauth.png" width="600" />